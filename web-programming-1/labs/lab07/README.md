...
This route will DELETE the animal with the provided `id` __and all posts written by this animal.__ Upon deletion, you will return the following structure:  
```json
{
    "deleted": true,
    "data": {
