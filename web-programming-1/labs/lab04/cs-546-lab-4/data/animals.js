...
module.exports = {
    async create(name, animalType) {
        ...
        return await animalCollection.findOne({_id: ObjectId(insertInfo.insertedId)})
    },
    async getAll() {
        const animalCollection = await animals();
    ...
    async rename(id, newName){
        ...
        const renamedInfo = await animalCollection.updateOne({_id: parsedId}, {$set: renamedAnimal});
