...
const readTopTenBinnedImages = async () => {
  var allBinnedImages = await getAllBinnedImages();
  allBinnedImages.sort(function(obj1, obj2) {
    return obj1.numBinned - obj2.numBinned;
  });
  var topTen = allBinnedImages.slice(-10);
  return topTen;
};
